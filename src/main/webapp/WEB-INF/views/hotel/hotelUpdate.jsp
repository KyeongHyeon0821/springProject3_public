...
<div class="form-container">
  ...
  <form name="hotelForm" method="post" onsubmit="return fCheck();" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input type="text" name="name" id="name" value="${vo.name}" required autofocus>
    </div>

    <div class="form-group">
      <label for="address">호텔 주소</label>
      <input type="text" name="address" id="address" value="${vo.address}" required>
    </div>

    <div class="form-group">
      <label for="tel">호텔 연락처</label>
      <input type="tel" name="tel" id="tel" value="${vo.tel}">
    </div>

    <div class="form-group">
      <label for="description">호텔 소개</label>
      <textarea rows="6" name="description" id="description">${vo.description}</textarea>
    </div>

    <div class="form-group">
      <label for="thumbnailFile">대표 사진(썸네일)</label>
      <input type="file" name="thumbnailFile" id="thumbnailFile" onchange="thumbnailCheck(this)" accept=".jpg,.gif,.png,.jpeg,.webp">
    </div>
